...
# reservoirs.download_altimetry(product='S6', startdate=mekong.startdates['sentinel6'], enddate=mekong.enddates['sentinel6'], credentials=(mekong.creodias_user, mekong.creodias_pass))
